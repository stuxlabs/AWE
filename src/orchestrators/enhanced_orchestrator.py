...
from src.core.utils import Timer, get_timestamp, save_json_results
from src.core.config import XSSDetectionConfig

# Import agents
from src.xss_agent.agents.recon import ReconAgent
from src.xss_agent.analyzers.payload_generator import DynamicPayloadAgent
from src.xss_agent.agents.verifier import DynamicVerifierAgent
from src.xss_agent.agents.stored_xss import StoredXSSAgent
from src.xss_agent.agents.dom_xss import DOMXSSAgent

# MITM agent not available in new structure
